...
namespace Demo.Tests
{
    public class AssertStringsTests
    {
        ...
        public void StringsTools_UnirNomes_RetornarNomeCompleto()
        {
            ...
            // Act
            var nomeCompleto = sut.Unir("Jessica", "Alves");

            // Assert
            Assert.Equal("Jessica Alves", nomeCompleto);
        }
        ...
        public void StringsTools_UnirNomes_DeveIgnorarCase()
        {
            ...
            // Assert
            Assert.Equal("JESSICA ALVES", nomeCompleto, true);
        }
        ...
        public void StringsTools_UnirNomes_DeveConterTrecho()
        {
            ...
            // Assert
            Assert.Contains("ssica", nomeCompleto);
        }
        ...
        public void StringsTools_UnirNomes_DeveComecarCom()
        {
            ...
            // Assert
            Assert.StartsWith("Jes", nomeCompleto);
        }
